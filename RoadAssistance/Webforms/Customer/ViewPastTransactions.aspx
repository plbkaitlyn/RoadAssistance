...
<body>
    ...
    <div id="table" class="table table-hover table-dark">
        <div class="tableRow">
            <div class="tableHead tranID">#</div>
            <div class="tableHead cost">Cost:</div>
            <div class="tableHead contractor">Contractor Name:</div>
            <div class="tableHead review">Review:</div>
            <div class="tableHead rating">Rating:</div> 
        </div>
    </div>
    ...
    <tbody id="tableBody">
        <tr class="tableRow">
          <th scope="row">1</th>
          <td>$100</td>
          <td><input id="userInput" type="text" value="Jim Fixer" disabled/></td>
          <td>Good Price!</td>
          <td><button class="btn btn-primary editButton" type="submit" onclick="document.getElementById('userInput').disabled = false;">Edit</button></td>
        </tr>
        <tr class="tableRow">
          <th scope="row">2</th>
          <td>$100</td>
